...
class Liggghts(MakefilePackage):
    ...
    version('master', sha256='25f85350248e47980cd28b2fa95c74ad1eeb69a7a46b71ff40da66ca510a922c',
            url='https://github.com/CFDEMproject/LIGGGHTS-PUBLIC/archive/refs/heads/master.tar.gz')
    ...
    #patch("/root/Downloads/fix_liggghts_compilation.patch")
