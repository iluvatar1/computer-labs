...
class Vtk(CMakePackage):
    ...
    def setup_run_environment(self, env):
        env.prepend_path('CPATH', self.prefix.include.vtk)
        env.prepend_path('C_INCLUDE_PATH', self.prefix.include.vtk)
        env.prepend_path('CPLUS_INCLUDE_PATH', self.prefix.include.vtk)
        env.prepend_path('LIBRARY_PATH', self.prefix.lib.vtk)
