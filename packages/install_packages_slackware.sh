...
SRC=
if [ "$1" == "BASIC" ]; then
    PKG="monit fail2ban grace corkscrew djview4 lame  unrar smplayer valgrind valkyrie  chromium libreoffice openmpi openblas octave dropbox pip parallel pdftk"
elif [ "$1" == "NUMERIC" ]; then
