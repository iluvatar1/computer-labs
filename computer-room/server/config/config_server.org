...
*** Server installation
    I need to install =rrdtool=, =gangli= with gmetad activated, and
...
# Install rrdtool
echo "Downloading ganglia ..."
wget http://oss.oetiker.ch/rrdtool/pub/rrdtool-1.7.0.tar.gz
wget https://slackbuilds.org/slackbuilds/14.2/libraries/rrdtool.tar.gz
echo "Uncompressing and entering slackbuild dir ..."
tar xf rddtool.tar.gz
cd rddtool
mv ../rrdtool-1.7.0.tar.gz ./
bash rrdtool.SlackBuild
installpkg /tmp/rddtoo*
    #+END_SRC
