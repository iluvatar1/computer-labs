...
nb_vertex   = 5 # Number of vertices for group a
k_d         = 0.5 # proportion of discs
mu_pp = 0.4 # Friction coefficient in particle-particle contacts
mu_wp = 0.4 # Friction coefficient in wall-particle contacts
lx = 40. # Box size in the x axis
ly = 40. # Box size in the y axis
...
# properties.
nb_particles_d = round(nb_remaining_particles * k_d)      # Number of a_particle
for i in xrange(0,nb_remaining_particles,1):
  if (i<nb_particles_d):
    ...
    body=rigidPolygon(radius=radii[i], center=coor[2*i : 2*(i + 1)], nb_vertices=nb_vertex,
                        model=mod, material=plex, color='BLEUx')
  bodies += body
#-------------------------------------------------------------------------------
...
right.imposeDrivenDof(component=1, dofty='force')
right.imposeDrivenDof(component=2, dofty='vlocy')
right.imposeDrivenDof(component=3, dofty='vlocy')
up.imposeDrivenDof(component=1, dofty='vlocy')
up.imposeDrivenDof(component=2, dofty='force')
